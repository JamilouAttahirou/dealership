...
SECRET_KEY = 'django-insecure-nj^q3*20o#di9u(d3^b0$r$e3pu9!475-x*+j3-x5)yz)d%xkr'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'railway',
        'USER': 'postgres',
        'PASSWORD': 'elsdNfkLGDBcRGuWhuavRfRoBzPNDVMl', # os.environ['DB_PASSWORD_DEALERSHIP']
